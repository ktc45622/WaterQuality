...
/**
 * This class manages the bookmark_instance_types table in the database.
 * @author Joseph Horro
 * @version Spring 2011
 */
public interface DBMSBookmarkInstanceTypesManager {

    /**
     * Retrieves a bookmark type by name.
     * Note: names are unique so this method will return a single bookmark type
     * or null.
     * 
     * @param name The name of the bookmark to attempt to find.
    ...
    /**
     * Removes a given bookmark by name.
     * 
     * @param name The name of the bookmark to be removed.
     * @return True if successful, false if not or if an invalid object is
     * received.
     */
