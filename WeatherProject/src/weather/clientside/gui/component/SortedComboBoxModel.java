 ...
 *
 * Code used with permission from Rob Camick.
 * 
 * @author Rob Camick
 * @version Spring 2011
 */
public class SortedComboBoxModel extends DefaultComboBoxModel {
	...
	protected static Vector sortVector(Vector<Object> items, Comparator comparator)
	{
	 ...
	 *  Create a model with data and use the specified Comparator.
	 */
	public SortedComboBoxModel(Vector<Object> items, Comparator comparator)
	{
