...
/**
 * The <code>ManageGUIPropertyWindow</code> creates a form that lists all
 * properties available. Double click one property in the table can edit this
 * property Click add Property button can add one property into the database
 * Select one property that listed in the table and delete this property with
 * clicking the delete button
 *
 * @author Xiang Li(2014)
 */
public class ManageGUIPropertyWindow extends BUDialog {
    ...
    public ManageGUIPropertyWindow(ApplicationControlSystem appControl) {
        super(appControl);
    ...
    private void updateTable() {
        ...
        properties = propertyMgr.obtainAllGUIProperties();
    ...
    private void initComponents() {
        ...
        setTitle("Manage GUI Properties");
        setResizable(false);
    ...
    private void addPropertyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPropertyButtonActionPerformed
        new AddPropertyWindow(appControl, "gui");
        updateTable();
