...
/**
 * The <code>ManageWeatherStationNoSolarPropertyWindow</code> creates a form
 * that lists all properties available. Double click one property in the table
 * can edit this property Click add Property button can add one property into
 * the database Select one property that listed in the table and delete this
 * property with clicking the delete button
 *
 * @author Xiang Li(2014)
 */
public class ManageWeatherStationNoSolarVariablePropertyWindow extends BUDialog {
    ...
    public ManageWeatherStationNoSolarVariablePropertyWindow(ApplicationControlSystem appControl) {
        super(appControl);
    ...
    /**
     * Gets all the gui properties from the database and list all of them in the
     * table
     */
    private void updateTable() {
        ...
        properties = propertyMgr.obtainAllWeatherStationNoSolarVariableProperties();
    ...
    private void initComponents() {
        ...
        setTitle("Manage Weather Station Single Variable w/o Solar Radiation Properties");
        setResizable(false);
     ...
     * administrators can use this window to insert one property into the
     * database
     *
     * @param evt
     */
    private void addPropertyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPropertyButtonActionPerformed
        new AddPropertyWindow(appControl, "wunder_nosolar");
        updateTable();
    }//GEN-LAST:event_addPropertyButtonActionPerformed

    /**
     * Select one property that listed in the table and delete this property
