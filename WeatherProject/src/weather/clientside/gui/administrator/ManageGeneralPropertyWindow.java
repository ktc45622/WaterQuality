...
/**
 * The <code>ManageGeneralPropertyWindow</code> creates a form that 
 ...
 */
public class ManageGeneralPropertyWindow extends BUDialog {
    ...
    /**
     * Creates new form ManagePropertyWindow
     */
    public ManageGeneralPropertyWindow(ApplicationControlSystem appControl) {
        super(appControl);
    ...
    private void updateTable(){
        ...
        properties = propertyMgr.obtainAllGeneralProperties();       
    ...
    private void initComponents() {
        ...
        setTitle("Manage General Weather Properties");
        setResizable(false);
    ...
    private void addPropertyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPropertyButtonActionPerformed
        new AddPropertyWindow(appControl, "general");
        updateTable();
