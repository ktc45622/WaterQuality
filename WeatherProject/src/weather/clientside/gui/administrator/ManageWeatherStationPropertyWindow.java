...
/**
 * The <code>ManageWeatherStationPropertyWindow</code> creates a form that 
 ...
 */
public class ManageWeatherStationPropertyWindow extends BUDialog {
    ...
    public ManageWeatherStationPropertyWindow(ApplicationControlSystem appControl) {
        super(appControl);
    ...
    private void updateTable(){
        ...
        properties = propertyMgr.obtainAllWeatherStationVariableProperties();
    ...
    private void initComponents() {
        ...
        setTitle("Manage Weather Station Single Variable w/ Solar Radiation Properties");
        setResizable(false);
    ...
    private void addPropertyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPropertyButtonActionPerformed
        new AddPropertyWindow(appControl, "wunder");
        updateTable();
